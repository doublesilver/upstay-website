          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {befores.length > 0 && (
              <div className="flex flex-col">
                ...
                <div
                  ref={beforeRef}
                  className="relative aspect-[2/1] border border-[#ccc] rounded-lg overflow-hidden bg-[#E8F5E9]"
                >
                  <Image
                  ...
                  <div className="grid grid-cols-8 gap-1 mt-1">
                    {befores.map((url, i) => (
                      <button
                        ...
                        className={`aspect-square border rounded overflow-hidden bg-[#E8F5E9] relative ${
                          i === beforeIdx
                            ? "border-2 border-[#111]"
                            : "border border-[#ccc]"
                        }`}
